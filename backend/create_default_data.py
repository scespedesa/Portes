...
def new_porte(nom,batiment_id,description,specifications,type_detection,modele,largeur_cm, hauteur_cm,
    ...
    porte = Porte( nom= nom , batiment_id = batiment_id ,description= description, specifications= specifications,
                  type_detection= type_detection,modele= modele,largeur_cm=largeur_cm, hauteur_cm=hauteur_cm,
                  annee=annee,exterieur_interieur=exterieur_interieur,automate=automate,voyant_sous_tension=voyant_sous_tension,
                  voyant_defaut=voyant_defaut, condamne=condamne, freq_utilisation=freq_utilisation )
    into_db(porte)
